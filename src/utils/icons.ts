export const fileIcons = {
  ...
  icons: [
    ...
    { name: "vfl", fileExtensions: ["vfl"] },
    { name: "kl", fileExtensions: ["kl"] },
    {
      name: "postcss",
    ...
    { name: "prisma", fileExtensions: ["prisma"] },
    ...
    { name: "gleam", fileExtensions: ["gleam"] },
    {
      name: "steadybit",
